...
CUDA_VISIBLE_DEVICES=1 python main_classwise.py --method MME --dataset multi --source real --target sketch --num 3 --net resnet34 --augmentation_policy rand_augment --uda 1 --use_bank 1 --patience 20 --save_check

...
CUDA_VISIBLE_DEVICES=0,1 python main.py --method MME --dataset multi --source real --target sketch --num 1 --net resnet34 --augmentation_policy rand_augment --uda 1 --use_bank 1 --save_check

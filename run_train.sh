...
CUDA_VISIBLE_DEVICES=0,1 python main_classwise.py --method MME --dataset multi --source sketch --target painting --num 3 --net resnet34 --augmentation_policy rand_augment --which_method SEW --uda 1 --use_bank 1 --use_cb 0 --use_new_features 0 --patience 5 --data_parallel 1 --weigh_using target_acc --num_to_weigh 2 --save_check

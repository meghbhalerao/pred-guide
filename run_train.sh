...
CUDA_VISIBLE_DEVICES=1 python main_classwise.py --method MME --dataset multi --source painting --target real --num 3 --net alexnet --augmentation_policy rand_augment --uda 1 --use_bank 1 --use_cb 0 --use_new_features 0 --patience 20 --data_parallel 0 --weigh_using target_acc --save_check

...
CUDA_VISIBLE_DEVICES=0,1 python main_classwise.py --method MME --dataset multi --source real --target sketch --num 3 --net resnet34 --augmentation_policy rand_augment --uda 1 --use_bank 1 --use_cb 0 --patience 20 --data_parallel 1 --weigh_using pseudo_labels --save_check

...
CUDA_VISIBLE_DEVICES=0,1 python main.py --method MME --dataset multi --source real --target sketch --num 3 --net resnet34 --augmentation_policy rand_augment --uda True --use_bank False --save_check
